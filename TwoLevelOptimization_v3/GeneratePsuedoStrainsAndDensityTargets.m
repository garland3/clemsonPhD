...
%         genFunction(net,'predictPseudoStrainAndTarget.m');
        ...
        % ----------------------------------
        % Try to find jumps in the data. 
        % ----------------------------------
        temp=config.targetTestVectorLen-1;
        term1 =0:0.5/temp:0.5; % -1 to 1 is the domain
        term2 =0:0.5/temp:0.5;  % -1 to 1 is the domain
        term3 =-0.3:1/temp:0.3;  % -1 to 1 is the domain
        densityTargetsVector = 2/temp:1/temp:1-1/temp;
        ...
        D11_v2 = reshape(D11,[t1 t2 t3 t4 ]);
          D_array=[D11;D12;D22;D33];
