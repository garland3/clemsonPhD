        ...
        function obj = CalculateTopologySensitivity(obj, config, matProp, loop)
            ...
            for ely = 1:config.nely
                ...
                for elx = 1:config.nelx
                    ...
                    e = obj.GetNodeNumberGivenXY(config, elx,ely);
                    KEgeneric = matProp.getKMatrixTopExxYyyRotVars(config,1,obj.Exx(ely,elx), obj.Eyy(ely,elx),obj.t(ely,elx),obj.w(ely,elx),e);
