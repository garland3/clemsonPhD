/* -*- c++ -*- */
/*  17-2-2014 Dual extruder met mix functie
    8-03-2014 unused pin() toegevoegd i.v.m. defineren ongebruikte pins
    31-5-2014 code aangepast 0.1% stappen in gradient
*/
/*
...
void init_unused_io()
    { 
      pinMode(UNUSED_1_PIN, OUTPUT);
      digitalWrite(UNUSED_1_PIN, LOW);
    }
...
void process_commands()
{
  ...
  if(code_seen('G'))
  {
    ...
    case 92: // G92
     ...
     case 93: //G93
     if (code_seen('R')){
     ratio=constrain(code_value(),0,100.0);
     }
     break;
  ...
  else if(code_seen('M'))
  {
    ...
    case 104: // M104
      ...
      if (code_seen('S')) setTargetHotend(code_value(), 0); //  '0' was tmp_extruder
#ifdef DUAL_X_CARRIAGE
  ...
  else if(code_seen('T'))
  {
    ...
    if(tmp_extruder == 0) {ratio=100;}
    if(tmp_extruder == 1) {ratio=0;}
