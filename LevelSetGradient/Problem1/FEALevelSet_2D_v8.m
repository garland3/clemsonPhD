...
function [displacmentY,cost,maxDisplacement] = FEALevelSet_2D_v8(xpoints,ypoints,zpoints, doplot)
...
if(problem ==1)
    ...
    splineZZ_v2 =  interp2(xpoints,ypoints,zpoints,splineXX_v2,splineYY_v2,'spline'); % spline value at each x column
