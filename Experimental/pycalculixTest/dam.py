...
model.plot_geometry(proj_name+'_geom') # view the points, lines, and areas
...
model.plot_elements(proj_name+'_elem')   # plot the part elements
...
model.plot_pressures(proj_name+'_press_1')
