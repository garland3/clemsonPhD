...
subplotX = 2;
subplotCount = 1;
multiplierScale = 2; % When plotting the diplaced elements, exaggerate the displacements by this scale
...
Essential2 = [Essential2 row*2]; % bottom right corner is only fixed in the y direction
